...
student_data = {
    "id1": {"name": "Shyam", "class": "V", "subject": "english, math, science"},
    "id2": {"name": "Ram", "class": "V", "subject": "english, math, science"},
    "id3": {"name": "Shyam", "class": "V", "subject": "english, math, science"},
    "id4": {"name": "Virat", "class": "V", "subject": "english, coding, math"}
}
